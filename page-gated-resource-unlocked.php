<?php /* Template Name: Unlocked Gated Resource*/ ?>
<?php
	...
	<section class="static-no-slider green-logos-bg text-section">
		<div class="container">
			<div class="col-md-7 col-sm-8 col-xs-12 no-x-padding">
				<h1 class="underlined-heading white-underlined wow fadeInRight" data-wow-duration="0.5s"><?php echo $resource_post->post_title?></h1>
			...
			if ( $is_gated == 1 )
			{
				...
				<div class="row">
					...
					<div class="col-md-6 col-sm-6 col-xs-12">
						<?php echo apply_filters('the_content', $resource_post->post_content); ?>
					</div>
				</div>
